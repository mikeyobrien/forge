...
import { Graph, GraphNode, GraphStats, GraphAnalysis, SuggestedConnection } from './types.js';
...
export class GraphAnalyzer {
   ...
   */
  findRelatedDocuments(graph: Graph, docPath: string, limit: number = 10): GraphNode[] {
